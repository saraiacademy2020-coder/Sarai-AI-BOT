...
// التعديل الآمن: سحب المفتاح من إعدادات Render
...
async function connectToWhatsApp() {
    ...
    sock.ev.on('messages.upsert', async ({ messages }) => {
        ...
        if (text) {
            ...
            const prompt = `أنتِ سراي، مساعدة ذكية لـ Sarai Coworking Space في الجيزة. ردي بلهجة مصرية عامية ومختصرة جداً. دي معلومات المكان: ${prices}. العميل بيقول: ${text}`;
